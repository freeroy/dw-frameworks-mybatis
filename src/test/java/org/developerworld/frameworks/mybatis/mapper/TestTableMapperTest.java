...
public class TestTableMapperTest {
	...
	public void testUpdate() {
		testInsert();
		TestTable testTable = testTableMapper.selectList(new OrderByCommand("ID desc"), new RowBoundCommand(0, 1))
				.get(0);
	...
	public void testSelectListByName() {
		...
		Assert.assertTrue(datas.size() == 2);
		datas = testTableMapper.selectListByName("%a%", null, new RowBoundCommand(1, 2));
		List<TestTable> datas2 = testTableMapper.selectListByName("%a%", new OrderByCommand("ID desc"),
				new RowBoundCommand(1, 2));
		Assert.assertTrue(!datas.equals(datas2));
	}
	...
	public void testSelectListByNames() {
		...
		Assert.assertTrue(datas.size() == 2);
		datas = testTableMapper.selectListByNames(new String[] { "%a%", "%b%" }, null, new RowBoundCommand(1, 2));
		List<TestTable> datas2 = testTableMapper.selectListByNames(new String[] { "%a%", "%b%" },
				new OrderByCommand("ID desc"), new RowBoundCommand(1, 2));
		Assert.assertTrue(!datas.equals(datas2));
	}
